...
locals {
  table_suffix = doublecloud_transfer.metrika-transfer.id
}
            ...
            "definitions" : [
              {
                ...
                "title" : "metrika__hits_v2_${local.table_suffix}"
              }
            ],
            "joins" : [],
          ...
          "sources" : [
            {
              ...
              "spec" : {
                "db_name" : "default",
                "kind" : "sql_table",
                "table_name" : "metrika__hits_v2_${local.table_suffix}"
              },
